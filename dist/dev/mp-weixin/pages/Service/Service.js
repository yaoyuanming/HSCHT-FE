...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    c: common_vendor.sr("popup", "09904383-0"),
    d: common_vendor.p({
      type: "bottom",
      ["safe-area"]: false
    })
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "B:/海丝出海通/hscht/miniprogram-project/src/pages/Service/Service.vue"]]);
