...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    o: common_vendor.t($data.services[$data.currentService].name)
  } : {});
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "B:/海丝出海通/hscht/miniprogram-project/src/pages/Home/Component/Home_Service.vue"]]);
